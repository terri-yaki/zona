...
const createStyles = () => StyleSheet.create({
  ...
  templatesTitle: { color: colors.primaryText, fontSize: 14, fontWeight: '800' },
  ...
  template: { backgroundColor: colors.surface, borderRadius: radius.full, color: colors.primaryText, fontSize: 11, fontWeight: '700', overflow: 'hidden', paddingHorizontal: 9, paddingVertical: 6 },
