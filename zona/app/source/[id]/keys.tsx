...
const createStyles = () => StyleSheet.create({
  ...
  prefix: { color: colors.primaryText, fontFamily: Platform.select({ ios: 'Menlo', default: 'monospace' }), fontSize: 12, marginTop: 4 },
  ...
  actionText: { color: colors.primaryText, fontSize: 12, fontWeight: '700' },
  ...
  doneText: { color: colors.primaryText, fontSize: 14, fontWeight: '700' },
