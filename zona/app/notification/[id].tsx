...
const createStyles = () => StyleSheet.create({
  ...
  inboxButtonText: { color: colors.primaryText, fontSize: 13, fontWeight: '700' },
  ...
  avatarText: { color: colors.primaryText, fontSize: 19, fontWeight: '800' },
  ...
  deliveryTitle: { color: colors.primaryText, fontSize: 13, fontWeight: '800', marginTop: 2 },
  ...
  deliveryRetryText: { color: colors.primaryText, fontSize: 11, fontWeight: '800' },
  ...
  quickActionText: { color: colors.primaryText, fontSize: 13, fontWeight: '700' },
