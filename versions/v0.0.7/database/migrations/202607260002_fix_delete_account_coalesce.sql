-- Fix account deletion: delete_account_data_internal called
-- pg_catalog.coalesce(...), but COALESCE is a SQL keyword, not a pg_catalog
-- function, so the RPC failed with 42883 and delete-account always returned
-- INTERNAL_ERROR. Identical body except the two coalesce sites.
